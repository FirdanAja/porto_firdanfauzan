  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 p-4 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white/10 border border-white/20 group-hover/pin:border-white/30 transition-transform duration-700 overflow-hidden -translate-x-1/2 -translate-y-1/2"
        >
...
export const PinPerspective = ({ title }: { title?: string }) => {
  return (
    <motion.div className="pointer-events-none w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition-opacity duration-500">
      <div className="relative w-full h-full -mt-7">
        {/* Title Button */}
        <div className="absolute top-0 inset-x-0 flex justify-center">
          <div className="relative flex items-center space-x-2 z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/20">
